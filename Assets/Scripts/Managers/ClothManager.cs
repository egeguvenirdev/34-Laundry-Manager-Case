...
public class ClothManager : MonoBehaviour
{
    ...
    private void OnGetSelectedClothes(DyeMachineBase machine)
    {
        if (currentCloth != null)
        {
            ...
            ReplaceClothes();
            StartCoroutine(machine.ProduceClothes(currentCloth.StartDyeProcess(machine.GetClothesTransform, machine.GetColor, machine.GetPaintDuration, machine.GetColorType)));
        }
    }
